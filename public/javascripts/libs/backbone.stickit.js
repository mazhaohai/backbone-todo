...
(function (factory) {
  ...
  Stickit.ViewMixin = {
    ...
    // delete bindings for the given `models` and its corresponding view events.
    ...
    // Using `this.bindings` configuration or the `optionalBindingsConfig`, binds `this.models`
    ...
    stickit: function(optionalModel, optionalBindingsConfig) {
      ...
      // Wrap `view.remove` to unbind stickit models and dom events.
    ...
    // Add a single models binding to the view
    addBinding: function(optionalModel, second, _binding) {
      ...
      if (modelAttr) {
        // Setup one-way, form element to models, bindings.
