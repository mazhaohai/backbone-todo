  ...
  */
  var PageableCollection = Backbone.PageableCollection = Backbone.Collection.extend({
    ...
    /**
       ...
       @property {string} [state.sortKey=null] The models attribute to use for
       sorting.
    ...
    */
    ...
    /**
       Given a list of models or models attributues, bootstraps the full
       ...
       @param {string} [options.state.sortKey] The models attribute to use for
    ...
    */
    _makeCollectionEventHandler: function (pageCol, fullCol) {
      ...
      return function collectionEventHandler (event, model, collection, options) {
        ...
        // remove the models from the other collection as well
        if (event == "remove") {
          if (!options.onAdd) {
    ...
    */
    ...
    /**
       ...
       **Note:** this method has been further simplified since 1.1.7. While
       ...
       @return {Array.<Object>} An array of models objects
    */
    ...
    /**
       Parse server response for an array of models objects.

       This default implementation first checks whether the response has any
       state object as documented in #parse. If it exists, the array of models
    ...
    */
    ...
    /**
       Convenient method for making a `comparator` sorted by a models attribute
    ...
    */
    ...
    /**
       ...
       If a `sortValue` function is given, it will be passed the `(models,
       sortKey)` arguments and is used to extract a value from the models during
       comparison sorts. If `sortValue` is not given, `models.get(sortKey)` is
       used for sorting.
