	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		init: function (pathAnim) {
			...
			$.each(['cur', '_default', 'width', 'height', 'opacity'], function (i, fn) {
				...
				} else if (fn === '_default' && Tween) { // jQuery 1.8 models
					obj = propHooks[fn];
					fn = 'set';
				}
...
Chart.prototype = {
	...
	redraw: function (animation) {
		var chart = this,
			...
			isDirtyBox = chart.isDirtyBox, // toggle.tpl: check if it has actually changed?
...
extend(Series.prototype, {
	...
	addPoint: function (options, redraw, shift, animation) {
		...
		// toggle.tpl: consider series.removePoint(i) method
		if (shift) {
