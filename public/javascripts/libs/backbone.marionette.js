...
(function(root, factory) {
  ...
  Marionette.View = Backbone.View.extend({
    ...
    // Serialize a models by returning its attributes. Clones
  ...
  Marionette.ItemView = Marionette.View.extend({
    ...
    // each models in the collection is serialized by calling
    // the view's `serializeCollection` and put into an `items` array in
    // the resulting data. If both are found, defaults to the models.
  ...
  Marionette.CollectionView = Marionette.View.extend({
    ...
    // takes precedence.
    // This method receives the models that will be passed to the instance
