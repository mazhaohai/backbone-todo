...
(function($) {
	...
	Kwick.prototype.getOffsetsForExpanded = function() {
		// toggle.tpl: cache the offset values
	...
	Kwick.prototype.updatePanelStyles = function() {
		...
		for (var i = $panels.length; i--;) {
			prevOffset = offset;
			// toggle.tpl: maybe we do one last pass at the end and round offsets, rather than on every
			// update
	 ...
	 * toggle.tpl: hideous code, needs refactor for the eye bleeds
	 */
	 ...
	 * toggle.tpl: benchmark to see if this caching business is even at all necessary.
	 */
